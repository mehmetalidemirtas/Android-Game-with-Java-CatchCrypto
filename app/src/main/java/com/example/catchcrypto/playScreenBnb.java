...
public class playScreenBnb extends AppCompatActivity {
    TextView timeText;
    TextView scoreText;
    int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_screen_bnb);
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                finishDialog = new Dialog(playScreenBnb.this);
                ...
                button8.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(playScreenBnb.this,MainActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
