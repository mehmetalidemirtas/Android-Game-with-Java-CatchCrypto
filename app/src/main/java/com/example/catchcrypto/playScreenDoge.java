...
public class playScreenDoge extends AppCompatActivity {
    TextView timeText;
    TextView scoreText;
    int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_screen_doge);
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                finishDialog = new Dialog(playScreenDoge.this);
                ...
                button8.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(playScreenDoge.this,MainActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
